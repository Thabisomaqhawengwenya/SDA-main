...
import type { ContactMessage, PrayerRequest, AdminEvent, Sermon } from '../adminTypes'
...
export default function NotificationsPage() {
  ...
  const draftEv    = events.filter(e => e.status === 'draft').length
  const draftSerm  = sermons.filter(s => s.status === 'draft').length
